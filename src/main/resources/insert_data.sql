...
INSERT INTO demo.campaign (name, campaign_type, campaign_type_id, campaign_type_name, discount_type, discount, max_discount) VALUES
  ('Ucuz Iphone', 'PRODUCT', (SELECT id FROM demo.product WHERE demo.product.name = 'Apple Iphone 7 64 GB'), 'Ucuz Iphone', 'RATE', 5, 100),
  ('Mavi T-shirt İndirimde', 'PRODUCT', (SELECT id FROM demo.product WHERE demo.product.name = 'U.S. Polo Assn. Mavi T-shirt'), 'Mavi T-shirt', 'PRICE', 50, 0),
